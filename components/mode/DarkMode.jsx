...
export default function DarkMode() {
  ...
  return (
    <>
      <span
        className="bg-white w-[40px] hover:text-white hidden  h-[40px] rounded-full lg:flex justify-center items-center text-black hover:bg-[#4b72d2] transition-all duration-300 ease-in-out cursor-pointer ml-2 "
        onClick={toggle}
      >
